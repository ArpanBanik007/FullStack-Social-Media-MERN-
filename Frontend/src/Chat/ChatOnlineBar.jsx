...
function ChatOnlineBar() {
  ...
  return (
    <>
      <style>{`
        .online-bar { font-family: 'Inter', sans-serif; width: 100%; padding: 14px 0 10px; border-bottom: 1px solid var(--pluto-border); flex-shrink: 0; }
        .online-bar-label { font-size: 11px; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: var(--pluto-text-hint); padding: 0 16px 10px; }
        ...
        .online-avatar-ring { width: 52px; height: 52px; border-radius: 50%; padding: 2px; background: linear-gradient(135deg, #22d3ee, #818cf8); transition: transform 0.2s ease; }
        .online-user:hover .online-avatar-ring { transform: scale(1.08); }
        .online-avatar-inner { width: 100%; height: 100%; border-radius: 50%; border: 2px solid var(--pluto-bg-navbar); overflow: hidden; position: relative; }
        .online-avatar-inner img { width: 100%; height: 100%; object-fit: cover; }
        .online-dot { position: absolute; bottom: 2px; right: 2px; width: 10px; height: 10px; background: var(--pluto-online); border-radius: 50%; border: 2px solid var(--pluto-bg-navbar); box-shadow: 0 0 6px rgba(34,197,94,0.6); }
        .online-name { font-size: 11px; font-weight: 500; color: var(--pluto-text-hint); white-space: nowrap; max-width: 52px; overflow: hidden; text-overflow: ellipsis; }
      `}</style>
